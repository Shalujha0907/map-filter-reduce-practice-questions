...
console.log(
  minOf([3, 1, 4, 1, 5, 9, 2]), minOf([0, 1, 0, 1]),
  minOf([0, 0, 0])
);
...
console.log(
  sumPositiveNumbers([1, -2, 3, -4]), sumPositiveNumbers([-1, -2, -3]),
...
console.log(
  sumOfSquares([1, 2, 3, 4]), sumOfSquares([0, 1, 0, 1])
);
...
console.log(
  sumOfOddNumbers([1, 2, 3, 4, 5]), sumOfOddNumbers([0, 2, 4]),
  sumOfOddNumbers([7, 5])
);
...
console.log(
  findSumOfEvenSquares([1, 2, 3, 4]), findSumOfEvenSquares([1, 3, 5, 7])
);
...
console.log(
  concatenateWords(["hello", "world"]), concatenateWords(['', '', ''])
);
